...
def backup_world(bucket, backup_filename, key=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-k", "--key", help="The key to save the backup object as")
    ...
    if not backup_file:
        ...
        exit()
    backup_world(bucket=bucket, backup_filename=backup_file, key=args.key)
